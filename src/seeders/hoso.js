    ...
    await queryInterface.bulkInsert("Hosocanhan", [
      {
        ...
        linkHoSoOnline: "https://example.com/hoso1",
      ...
      },
      {
        ...
        linkHoSoOnline: "https://example.com/hoso2",
        ngayCapNhat: new Date(),
      ...
      },
      {
        ...
        linkHoSoOnline: "https://example.com/hoso3",
        ngayCapNhat: new Date(),
      ...
      },
      {
        ...
        linkHoSoOnline: "https://example.com/hoso4",
        ngayCapNhat: new Date(),
      ...
      },
      {
        ...
        linkHoSoOnline: "https://example.com/hoso5",
        ngayCapNhat: new Date(),
      ...
      },
      {
        ...
        linkHoSoOnline: "https://example.com/hoso6",
        ngayCapNhat: new Date(),
        NguoitimviecId: 6,
      },
      {
        ...
        linkHoSoOnline: "https://example.com/hoso7",
        ngayCapNhat: new Date(),
        NguoitimviecId: 7,
      },
      {
        ...
        linkHoSoOnline: "https://example.com/hoso8",
        ngayCapNhat: new Date(),
        NguoitimviecId: 8,
      },
      {
        ...
        linkHoSoOnline: "https://example.com/hoso9",
        ngayCapNhat: new Date(),
        NguoitimviecId: 9,
      },
      {
        ...
        linkHoSoOnline: "https://example.com/hoso10",
        ngayCapNhat: new Date(),
        NguoitimviecId: 10,
      },
    ]);
